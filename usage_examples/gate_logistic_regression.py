"""Usage example: GATE embedding + Logistic Regression classical model.
...
def evaluate_oos_binary(model, X_oos, y_oos):
    ...
    # Hybrid: GATE + Logistic Regression
...
def run_binary_example():
    print("=" * 70)
    print("EXAMPLE 1: Binary classification -- GATE + Logistic Regression")
    print("=" * 70)
...
def run_multiclass_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 2: Multiclass classification (4 classes) -- GATE + Logistic Regression")
    print("=" * 70)
...
def run_regression_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 3: Regression -- GATE + Logistic Regression")
    print("=" * 70)
