"""Usage example: TabTransformer embedding + Random Forest classical model.
...
def evaluate_oos_binary(model, X_oos, y_oos):
    ...
    # Hybrid: TabTransformer + Random Forest
...
def run_binary_example():
    print("=" * 70)
    print("EXAMPLE 1: Binary classification -- TabTransformer + Random Forest")
    print("=" * 70)
...
def run_multiclass_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 2: Multiclass classification (4 classes) -- TabTransformer + Random Forest")
    print("=" * 70)
...
def run_regression_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 3: Regression -- TabTransformer + Random Forest")
    print("=" * 70)
