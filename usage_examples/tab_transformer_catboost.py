"""Usage example: TabTransformer embedding + CatBoost classical model.
...
def evaluate_oos_binary(model, X_oos, y_oos):
    ...
    # Hybrid: TabTransformer + CatBoost
...
def run_binary_example():
    print("=" * 70)
    print("EXAMPLE 1: Binary classification -- TabTransformer + CatBoost")
    print("=" * 70)
...
def run_multiclass_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 2: Multiclass classification (4 classes) -- TabTransformer + CatBoost")
    print("=" * 70)
...
def run_regression_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 3: Regression -- TabTransformer + CatBoost")
    print("=" * 70)
