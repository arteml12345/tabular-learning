"""Usage example: CategoryEmbedding embedding + Elastic Net classical model.
...
# =====================================================================
# Embedding model search space: CategoryEmbedding
# =====================================================================

# Custom CategoryEmbedding search space.
category_embedding_search_space = {
    ...
    # Activation function (pytorch-tabular style names).
...
# No fixed params needed for CategoryEmbedding.
category_embedding_fixed_params = None
...
def evaluate_oos_binary(model, X_oos, y_oos):
    ...
    # Hybrid: CategoryEmbedding + Elastic Net
...
def build_embedding_step():
    """Build the EmbeddingStepConfig for CategoryEmbedding."""
    return EmbeddingStepConfig(
        # "category_embedding" = pytorch-tabular CategoryEmbedding (Mode B).
        model_type="category_embedding",

        search_space=category_embedding_search_space,
        fixed_params=category_embedding_fixed_params,
    )
...
def run_binary_example():
    print("=" * 70)
    print("EXAMPLE 1: Binary classification -- CategoryEmbedding + Elastic Net")
    print("=" * 70)
...
def run_multiclass_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 2: Multiclass classification (4 classes) -- CategoryEmbedding + Elastic Net")
    print("=" * 70)
...
def run_regression_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 3: Regression -- CategoryEmbedding + Elastic Net")
    print("=" * 70)
