"""Usage example: MLP embedding + CatBoost classical model.
...
hybrid (NN + CatBoost) are evaluated on the held-out OOS half, so
...
# =====================================================================
# Classical model search space: CatBoost
# =====================================================================

# Custom CatBoost search space (same for classification and regression).
...
catboost_fixed_params = {
    # Silence CatBoost's internal logging.
    "verbose": 0,
}
...
def build_classical_step(task="binary"):
    """Build the ClassicalStepConfig for CatBoost."""
    return ClassicalStepConfig(
        model_type="catboost",
        model_class=None,
        search_space=catboost_search_space,
        fixed_params=catboost_fixed_params,
...
def run_binary_example():
    print("=" * 70)
    print("EXAMPLE 1: Binary classification -- MLP + CatBoost")
    print("=" * 70)
...
def run_multiclass_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 2: Multiclass classification (4 classes) -- MLP + CatBoost")
    print("=" * 70)
...
def run_regression_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 3: Regression -- MLP + CatBoost")
    print("=" * 70)
