"""Usage example: TabNet embedding + Elastic Net classical model.
...
# =====================================================================
# Embedding model search space: TabNet
# =====================================================================

# Custom TabNet embedding search space.
tabnet_search_space = {
    # Width of the decision prediction layer in each step.
    "n_d": hp.choice("n_d", [8, 16, 32, 64]),

    # Width of the attention layer in each step.
    "n_a": hp.choice("n_a", [8, 16, 32, 64]),

    # Number of sequential attention steps.
    "n_steps": hp.quniform("n_steps", 3, 10, 1),

    # Coefficient for feature reusage in attention.
    "gamma": hp.uniform("gamma", 1.0, 2.0),

    # Relaxation factor for the TabNet sparsity regularization.
...
# No fixed params needed for TabNet.
tabnet_fixed_params = None
...
def build_embedding_step():
    """Build the EmbeddingStepConfig for TabNet."""
    return EmbeddingStepConfig(
        # "tabnet" = pytorch-tabular TabNet (Mode B).
        model_type="tabnet",

        search_space=tabnet_search_space,
        fixed_params=tabnet_fixed_params,
    )
...
def run_binary_example():
    print("=" * 70)
    print("EXAMPLE 1: Binary classification -- TabNet + Elastic Net")
    print("=" * 70)
...
def run_multiclass_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 2: Multiclass classification (4 classes) -- TabNet + Elastic Net")
    print("=" * 70)
...
def run_regression_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 3: Regression -- TabNet + Elastic Net")
    print("=" * 70)
