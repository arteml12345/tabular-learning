"""Usage example: MLP embedding + Extra Trees classical model.
...
hybrid (NN + Extra Trees) are evaluated on the held-out OOS half, so
...
# =====================================================================
# Classical model search space: Extra Trees
# =====================================================================

# Custom Extra Trees search space (same for classification and regression).
...
# No fixed params needed for Extra Trees.
extra_trees_fixed_params = None
...
def build_classical_step(task="binary"):
    """Build the ClassicalStepConfig for Extra Trees."""
    return ClassicalStepConfig(
        model_type="extra_trees",
        model_class=None,
        search_space=extra_trees_search_space,
        fixed_params=extra_trees_fixed_params,
...
def run_binary_example():
    print("=" * 70)
    print("EXAMPLE 1: Binary classification -- MLP + Extra Trees")
    print("=" * 70)
...
def run_multiclass_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 2: Multiclass classification (4 classes) -- MLP + Extra Trees")
    print("=" * 70)
...
def run_regression_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 3: Regression -- MLP + Extra Trees")
    print("=" * 70)
