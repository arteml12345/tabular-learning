"""Usage example: TabNet embedding + Random Forest classical model.
...
def run_binary_example():
    print("=" * 70)
    print("EXAMPLE 1: Binary classification -- TabNet + Random Forest")
    print("=" * 70)
...
def run_multiclass_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 2: Multiclass classification (4 classes) -- TabNet + Random Forest")
    print("=" * 70)
...
def run_regression_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 3: Regression -- TabNet + Random Forest")
    print("=" * 70)
