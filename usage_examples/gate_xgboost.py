"""Usage example: GATE embedding + XGBoost classical model.
...
def run_binary_example():
    print("=" * 70)
    print("EXAMPLE 1: Binary classification -- GATE + XGBoost")
    print("=" * 70)
...
def run_multiclass_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 2: Multiclass classification (4 classes) -- GATE + XGBoost")
    print("=" * 70)
...
def run_regression_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 3: Regression -- GATE + XGBoost")
    print("=" * 70)
