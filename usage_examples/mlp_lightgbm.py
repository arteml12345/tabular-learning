"""Usage example: MLP embedding + LightGBM classical model.
...
hybrid (NN + LightGBM) are evaluated on the held-out OOS half, so
...
# =====================================================================
# Classical model search space: LightGBM
# =====================================================================

# Custom LightGBM search space (same for classification and regression).
lightgbm_search_space = {
    ...
    # Column subsampling fraction.
    "colsample_bytree": hp.uniform("colsample_bytree", 0.5, 1.0),

    # Minimum number of samples required in a child leaf.
...
lightgbm_fixed_params = {
    # Silence LightGBM's internal logging.
    "verbose": -1,
}
...
def build_classical_step(task="binary"):
    """Build the ClassicalStepConfig for LightGBM."""
    return ClassicalStepConfig(
        model_type="lightgbm",
        model_class=None,
        search_space=lightgbm_search_space,
        fixed_params=lightgbm_fixed_params,
...
def run_binary_example():
    print("=" * 70)
    print("EXAMPLE 1: Binary classification -- MLP + LightGBM")
    print("=" * 70)
...
def run_multiclass_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 2: Multiclass classification (4 classes) -- MLP + LightGBM")
    print("=" * 70)
...
def run_regression_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 3: Regression -- MLP + LightGBM")
    print("=" * 70)
