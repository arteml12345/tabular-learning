"""Usage example: MLP embedding + Ridge classical model.
...
hybrid (NN + Ridge) are evaluated on the held-out OOS half, so
...
# =====================================================================
# Classical model search space: Ridge
# =====================================================================

# Classification uses LogisticRegression (with C); regression uses Ridge
# (with alpha). Since they have different hyperparameters, we define
# separate spaces.
...
# Regression search space (sklearn Ridge):
...
def build_classical_step(task="binary"):
    """Build the ClassicalStepConfig for Ridge."""
    if task == "regression":
...
def run_binary_example():
    print("=" * 70)
    print("EXAMPLE 1: Binary classification -- MLP + Ridge")
    print("=" * 70)
...
def run_multiclass_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 2: Multiclass classification (4 classes) -- MLP + Ridge")
    print("=" * 70)
...
def run_regression_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 3: Regression -- MLP + Ridge")
    print("=" * 70)
