"""Usage example: MLP embedding + Logistic Regression classical model.
...
hybrid (NN + Logistic Regression) are evaluated on the held-out OOS half, so
...
# =====================================================================
# Classical model search space: Logistic Regression
# =====================================================================

# Classification uses LogisticRegression; regression uses Ridge.
# Since they have different hyperparameters, we define separate spaces.

# Classification search space (LogisticRegression):
...
# Regression search space (Ridge):
regression_search_space = {
    # Regularization strength; larger = stronger regularization.
    "alpha": hp.loguniform("alpha", np.log(1e-4), np.log(1e4)),
}

# Regression fixed params:
regression_fixed_params = None
...
def evaluate_oos_binary(model, X_oos, y_oos):
    ...
    # Hybrid: MLP + Logistic Regression
...
def build_classical_step(task="binary"):
    """Build the ClassicalStepConfig for Logistic Regression / Ridge."""
    if task == "regression":
...
def run_binary_example():
    print("=" * 70)
    print("EXAMPLE 1: Binary classification -- MLP + Logistic Regression")
    print("=" * 70)
...
def run_multiclass_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 2: Multiclass classification (4 classes) -- MLP + Logistic Regression")
    print("=" * 70)
...
def run_regression_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 3: Regression -- MLP + Logistic Regression")
    print("=" * 70)
