"""Usage example: MLP embedding + Random Forest classical model.
...
hybrid (NN + Random Forest) are evaluated on the held-out OOS half, so
...
# =====================================================================
# Classical model search space: Random Forest
# =====================================================================

# Custom Random Forest search space (same for classification and regression).
...
# No fixed params needed for Random Forest.
random_forest_fixed_params = None
...
def build_classical_step(task="binary"):
    """Build the ClassicalStepConfig for Random Forest."""
    return ClassicalStepConfig(
        model_type="random_forest",
        model_class=None,
        search_space=random_forest_search_space,
        fixed_params=random_forest_fixed_params,
...
def run_binary_example():
    print("=" * 70)
    print("EXAMPLE 1: Binary classification -- MLP + Random Forest")
    print("=" * 70)
...
def run_multiclass_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 2: Multiclass classification (4 classes) -- MLP + Random Forest")
    print("=" * 70)
...
def run_regression_example():
    print("\n" + "=" * 70)
    print("EXAMPLE 3: Regression -- MLP + Random Forest")
    print("=" * 70)
